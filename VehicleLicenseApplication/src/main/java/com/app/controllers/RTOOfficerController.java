...
public class RTOOfficerController {
	...
	public String officerLogin(@Valid @RequestBody RTOOfficer officer)
...
/*
 * @PostMapping(path = "/application/modifyresult") public Application
 * modifyResult(@Valid int applicationNumber) throws
 * ApplicationNotFoundException{ { return
 * service.modifyTestResultById(applicationNumber); }
 * 
 * @PostMapping(path="/license/generatell") public String
 * generateLearnerLicense(@Valid @RequestBody String appno) throws
 * CannotGenerateLearnerLicenseException { return
 * service.generateLearnerLicense(appno); }
 * 
 * @PostMapping(path="/license/generatedl") public String
 * generateDrivingLicense(@Valid @RequestBody String appno) throws
 * CannotGenerateDrivingLicenseException { return
 * service.generateDrivingLicense(appno); }
 */